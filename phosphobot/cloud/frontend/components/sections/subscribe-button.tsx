    ...
    return (
      <div className="flex justify-center">
        <form action="/api/checkout_sessions" method="POST">
          ...
          <button
            onClick={onClick}
            className={`bg-primary-blue hover:bg-primary-blue-dark text-white hover:text-primary-blue-light font-semibold py-3 px-12 rounded-lg transition-colors duration-200 ${className}`}
            type="submit"
          >
            {children}
          </button>
